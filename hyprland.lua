...
hl.bind("switch:on:[Lid Switch]", hl.dsp.exec_cmd("$HOME/.my-scripts/monitors/clamshell.sh close"), { locked = false })

-- off = OPENING the laptop lid
-- bindl = , switch:off:Lid Switch, exec, $HOME/.my-scripts/monitors/clamshell.sh open
hl.bind("switch:off:[Lid Switch]", hl.dsp.exec_cmd("$HOME/.my-scripts/monitors/clamshell.sh open"), { locked = false })
